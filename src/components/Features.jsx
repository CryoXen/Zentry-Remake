    ...
    return(
        <div className="relative size-full">
            ...
            justify-between p-5 text-blue-50">
                ...
                { description &&(
                    <p className="mt-3 max-w-54 text-xs
        ...
        <div className="container mx-auto px-3 md:px-10">
            <div className="px-5 py-32">
                ...
                text-blue-50 opacity-50">
                    Inmerse yourself in a rich and ever-expanding universe where a vibrant array of 
                    products converge into an interconnected overlay experience on your world.
                </p>
            </div>
            <BentoTilt className="border-hsla relative mb-7 h-95 w-full
            ...
            <div className="grid h-[135vh] grid-cols-2 grid-rows-3 gap-7">
                ...
                <BentoTilt className="bento-tilt_1 row-span-1 ms-32 md:col-span-1 md:ms-0">
                    ...
                    to social interaciton for Web3 communities."
                    />
                </BentoTilt>
